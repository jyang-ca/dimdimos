...
all_blueprints = {
    ...
    "drone-go2-lidar-fusion-sim": "dimos.robot.unitree.go2.blueprints.sim.drone_go2_lidar_fusion_sim:drone_go2_lidar_fusion_sim",
    "drone-go2-lidar-fusion-sim-agentic-mcp": "dimos.robot.unitree.go2.blueprints.sim.drone_go2_lidar_fusion_sim_agentic_mcp:drone_go2_lidar_fusion_sim_agentic_mcp",
    "drone-lidar-basic": "dimos.robot.drone.blueprints.basic.drone_lidar_basic:drone_lidar_basic",
    "drone-lidar-mapping": "dimos.robot.drone.blueprints.mapping.drone_lidar_mapping:drone_lidar_mapping",
    "drone-lidar-mapping-sim": "dimos.robot.drone.blueprints.sim.drone_lidar_mapping_sim:drone_lidar_mapping_sim",
...
all_modules = {
    ...
    "drone-go2-fusion-skills": "dimos.robot.unitree.go2.drone_go2_fusion_skills",
    "drone-map-to-go2-obstacle-layer": "dimos.robot.unitree.go2.drone_fusion_costmap",
    ...
    "go2-costmap-fusion": "dimos.robot.unitree.go2.drone_fusion_costmap",
    ...
    "mapping-health-monitor": "dimos.mapping.health",
    ...
    "sensor-mission-monitor": "dimos.agents.autonomy.sensor_mission_monitor",
    ...
    "zone-inspection-skill": "dimos.agents.skills.zone_inspection",
}
